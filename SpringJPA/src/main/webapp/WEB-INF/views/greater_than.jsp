...
<html>
	...
	<body>
		<form:form id="searchForm5"  name="searchForm5" modelAttribute="searchBackingBean" >
			<div class="demoapp-skin-sam">
				<div class="demoapp-navset">
					<ul class="demoapp-nav">
						...
						<li class="selected"><a href="#" onclick="javascript:loadTab('5', document.searchForm5);"><em>GREATER THAN</em></a></li>
							...
							<table class="custom" border="0" cellpadding="3" cellspacing="0" width="100%" id="filterTable" align="center">
						  		<tr>
							  		<td colspan="3" align="left" width="100%" >
						  				<div class="info">Find all those employees whose salary is greater than given salary</div>
									</td>
							  	</tr>
							</table>
							<div class="borderbox">
										...
										<tr>
									  		<td>  
												<div class="buttonwrapper">
													<a class="squarebutton" onclick="this.disabled='true';document.searchForm5.action='searchEmployees-GreaterThan.do'; document.searchForm5.submit();">
														<span>Search</span>
													</a>
												</div>
											</td>
