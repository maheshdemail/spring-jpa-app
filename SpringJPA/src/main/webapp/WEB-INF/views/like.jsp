...
<html>
	<head>
		<meta name="useCaseName" content='Search Employee' />
		<title>Search Employee</title>
	</head>
	<body>
		<form:form id="searchForm2"  name="searchForm2" modelAttribute="searchBackingBean" >
			<div class="demoapp-skin-sam">
				<div class="demoapp-navset">
					<ul class="demoapp-nav">
						...
						<li class="selected"><a href="#" onclick="javascript:loadTab('2', document.searchForm2);"><em>LIKE</em></a></li>
							...
							<table class="custom" border="0" cellpadding="3" cellspacing="0" width="100%" id="filterTable" align="center">
						  		<tr>
							  		<td colspan="3" align="left" width="100%" >
						  				<div class="info">Find All Employees by First Name or Last Name</div>
									</td>
							  	</tr>
							</table>
							<div class="borderbox">
												...
												<tr>
													...
													<td width="60%">
														<fieldset style="border: 1px #336600;font-size: 11px;font-size:90%;">
															...
															<table class="custom" border="0" cellpadding="3" cellspacing="0" width="50%" id="filterTable" align="left">
				  												<tr>
				  												...
				  												<tr>
				  													...
				  													<td align="left" >
																		<form:input path="name" size="20" maxlength="20" cssClass="highlightBox" onblur="toUpperCase(this);"/>
																	 </td>
																	<td align="left" ><br> </td>
																</tr>
										...
										<tr>
									  		<td>  
												<div class="buttonwrapper">
													<a class="squarebutton" onclick="this.disabled='true';document.searchForm2.action='searchEmployees-Like.do'; document.searchForm2.submit();">
														<span>Search</span>
													</a>
												</div>
											</td>
