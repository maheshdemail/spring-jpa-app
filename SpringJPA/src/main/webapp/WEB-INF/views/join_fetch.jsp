...
<html>
	...
	<body>
		<form:form id="searchForm7" name="searchForm7" modelAttribute="searchBackingBean" >
			<div class="demoapp-skin-sam">
				<div class="demoapp-navset">
					<ul class="demoapp-nav">
						...
						<li class="selected"><a href="#" onclick="javascript:loadTab('7', document.searchForm7);"><em>JOIN FETCH</em></a></li>
					</ul>            
							...
							<table class="custom" border="0" cellpadding="3" cellspacing="0" width="100%" id="filterTable" align="center">
						  		<tr>
							  		<td colspan="3" align="left" width="100%" >
						  				<div class="info">Find All Employees</div>
									</td>
							  	</tr>
							</table>
							<div class="borderbox">
										...
										<tr>
									  		<td>  
												<div class="buttonwrapper">
													<a class="squarebutton" onclick="this.disabled='true';document.searchForm7.action='searchEmployees-JoinFetch.do'; document.searchForm7.submit();">
														<span>Search</span>
													</a>
												</div>
											</td>
