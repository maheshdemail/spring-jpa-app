...
<html>
	...
	<body>
		<form:form id="searchForm4"  name="searchForm4" modelAttribute="searchBackingBean" >
			<div class="demoapp-skin-sam">
				<div class="demoapp-navset">
					<ul class="demoapp-nav">
						...
						<li class="selected"><a href="#" onclick="javascript:loadTab('4', document.searchForm4);"><em>LESS THAN</em></a></li>
							...
							<table class="custom" border="0" cellpadding="3" cellspacing="0" width="100%" id="filterTable" align="center">
						  		<tr>
							  		<td colspan="3" align="left" width="100%" >
						  				<div class="info">Find all those employees whose salary is lesser than given salary</div>
									</td>
							  	</tr>
							</table>
							<div class="borderbox">
										...
										<tr>
									  		<td>  
												<div class="buttonwrapper">
													<a class="squarebutton" onclick="this.disabled='true';document.searchForm4.action='searchEmployees-LessThan.do'; document.searchForm4.submit();">
														<span>Search</span>
													</a>
												</div>
											</td>
