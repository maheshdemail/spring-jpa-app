...
<html>
	...
	<body>
		<form:form id="searchForm6"  name="searchForm6" modelAttribute="searchBackingBean" >
			<div class="demoapp-skin-sam">
				<div class="demoapp-navset">
					<ul class="demoapp-nav">
						...
						<li><a href="#" onclick="javascript:loadTab('4', document.searchForm6);"><em>LESS THAN</em></a></li>
						<li><a href="#" onclick="javascript:loadTab('5', document.searchForm5);"><em>GREATER THAN</em></a></li>
						<li class="selected"><a href="#" onclick="javascript:loadTab('6', document.searchForm6);"><em>IN</em></a></li>
							...
							<table class="custom" border="0" cellpadding="3" cellspacing="0" width="100%" id="filterTable" align="center">
						  		<tr>
							  		<td colspan="3" align="left" width="100%" >
						  				<div class="info">Find all employees by gender</div>
									</td>
							  	</tr>
							</table>
							<div class="borderbox">
										...
										<tr>
									  		<td>  
												<div class="buttonwrapper">
													<a class="squarebutton" onclick="this.disabled='true';document.searchForm6.action='searchEmployees-In.do'; document.searchForm6.submit();">
														<span>Search</span>
													</a>
												</div>
											</td>
