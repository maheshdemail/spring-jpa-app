...
/**
 * Simple JavaBean command object which is used in Protocol Information
 * view<br>. This JavaBean object acts as <b>Backing bean</b> for JSP page<br>
 * 
 * @author Mahesh Desai
 * @version $1.0
 */
public class EmployeeInformationBackingBean  {
	...
	public EmployeeInformationBackingBean() {
	}
